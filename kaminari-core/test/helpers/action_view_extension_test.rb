...
if defined?(::Rails::Railtie) && defined?(::ActionView)
  class ActionViewExtensionTest < ActionView::TestCase
    ...
    context '#paginate' do
      ...
      should 'escaping the pagination for javascript' do
        users = User.page(1)
      ...
      should 'allows for overriding params with the :params option' do
      ...
      should 'accepts :theme option' do
        users = User.page(1)
        begin
      ...
      should 'accepts :views_prefix option' do
        users = User.page(1)
        begin
          controller.append_view_path File.join(Gem.loaded_specs['kaminari-core'].gem_dir, 'test/fake_app/views')
      ...
      should 'accepts :paginator_class option' do
        users = User.page(1)
    ...
    context '#link_to_previous_page' do
      ...
      should '#link_to_previous_page accepts ActionController::Parameters' do
        users = User.page(3)
    ...
    context '# link_to_next_page' do
      ...
      should '#link_to_next_page accepts ActionController::Parameters' do
        users = User.page(1)
        params = ActionController::Parameters.new(controller: 'users', action: 'index', status: 'active')
    ...
    context '#page_entries_info' do
      context 'on a model without namespace' do
        ...
        context 'having more than one page of entries' do
          ...
          should 'it accepts a decorated object' do
      ...
      context 'I18n' do
        ...
        should 'page_entries_info translates entry' do
          users = User.page(1).per(25)
          begin
        ...
        context 'with any other locale' do
          teardown do
            I18n.backend.reload!
          end
          ...
          context ':de' do
            ...
            should 'the last page with default entry name' do
        ...
        context ':fr' do
          ...
          should 'having multiple entries with default entry name' do
            users = User.page(1).per(50)
      ...
      context 'on a model with namespace' do
        ...
        context 'having 1 entry' do
          ...
          should 'setting the entry name option to "place"' do
            addresses = User::Address.page(1).per(25)
      ...
      should 'on a PaginatableArray' do
    ...
    context '#rel_next_prev_link_tags' do
      setup do
